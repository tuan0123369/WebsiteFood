                                ...
                                <div class="card sameheight-item stats" data-exclude="xs">
                                    <div class="card-block">
                                        <div class="title-block">
                                            ...
                                            <p class="title-description"> Tình trạng tổng quan </p>
                                        </div>
                                        <div class="row row-sm stats-container">
                                            <div class="col-12 col-sm-6 stat-col">
                                                ...
                                                <div class="stat">
                                                    ...
                                                    <div class="name"> Tổng số sản phẩm </div>
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-6 stat-col">
                                                ...
                                                <div class="stat">
                                                    ...
                                                    <div class="name"> Số lượng đơn hàng </div>
                                                </div>
                                                <div class="progress stat-progress">
                                            ...
                                            <div class="col-12 col-sm-6  stat-col">
                                                ...
                                                <div class="stat">
                                                    ...
                                                    <div class="name"> Tổng người dùng </div>
                                                </div>
                                                <div class="progress stat-progress">
                                            ...
                                            <div class="col-12 col-sm-6  stat-col">
                                                ...
                                                <div class="stat">
                                                    ...
                                                    <div class="name"> Số bài viết </div>
                                                </div>
                                                <div class="progress stat-progress">
                                            ...
                                            <div class="col-12 col-sm-6 stat-col">
                                                ...
                                                <div class="stat">
                                                    ...
                                                    <div class="name"> Doanh thu tổng </div>
                                                </div>
                                                <div class="progress stat-progress">
                                ...
                                <div class="card sameheight-item" data-exclude="xs" id="dashboard-history">
                                    <div class="card-header card-header-sm bordered">
                                        ...
                                        <ul class="nav nav-tabs pull-right" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="#downloads" role="tab" data-toggle="tab">Tổng
                                                    quan</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-block">
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active fade show" id="visits">
                                                <p class="title-description"> Số lượt truy cập trong 30 ngày qua </p>
                                                <div id="dashboard-visits-chart"></div>
                                            </div>
                                            <div role="tabpanel" class="tab-pane fade" id="downloads">
                                                <p class="title-description"> Lươt truy cập các tháng </p>
