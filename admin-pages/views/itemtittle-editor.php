        ...
        <div class="app" id="app">
            ...
            <article class="content item-editor-page">
                <div class="title-block">
                    <h3 class="title"> Sửa danh mục <?php foreach ($list_cate as $cate) {
                                                        if ($cate->getId() == $item)
                                                            echo $cate->getCategory_name();
                                                    } ?> <span class="sparkline bar" data-type="bar"></span>
                    </h3>
                </div>
                <form action="../controller/categoriesController.php?id=<?php echo $item ?>" onsubmit="" method="POST" autocomplete="off" name="item">
                    <div class="card card-block">
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label text-xs-right"> Nhập tên danh mục: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control boxed" name="category_name" placeholder="Tên mới của danh mục" id="foodname">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10 col-sm-offset-2">
                                <button type="submit" class="btn btn-primary" name="action" value="editCate"> Xác nhận </button>
                            </div>
                        </div>
                    </div>
                </form>
